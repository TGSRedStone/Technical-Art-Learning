Shader "Cartoon/NPRBody"
{
    Properties
    {
        ...
        [NoScaleOffset]_ToonTex ("ToonTex", 2d) = "white" {}
        [NoScaleOffset]_MatCap ("MatCap", 2d) = "white" {}
        [NoScaleOffset]_ShadowRamp ("ShadowRamp", 2d) = "white" {}
        ...
        [Header(Rim)]
        _RimOffset ("RimOffset", range(1, 10)) = 6
        _RimThreshold ("RimThreshold", range(0, 0.1)) = 0.03
        _RimStrength ("RimStrength", range(0, 10)) = 0.6
        _RimMix ("RimMix", range(0, 1)) = 0.3
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i /*, bool IsFrontFace : SV_IsFrontFace*/) : SV_Target
            {
                ...
                float3 garyShadowCol = baseCol * grayShadowRampCol * _ShadowColor.rgb;
                float3 darkShadowCol = baseCol * darkShadowRampCol * _ShadowColor.rgb;
