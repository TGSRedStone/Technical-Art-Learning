...
public class BaseFurRenderFeature : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        {
            var scriptablePass = new BaseFurRenderPass(name, step, Event, filterSettings);
    ...
    public class BaseFurRenderPass : ScriptableRenderPass
    {
        ...
        public BaseFurRenderPass(string profilerTag, int step, RenderPassEvent renderPassEvent, FilterSettings filterSettings)
        {
            this.step = step;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            {
                cmd.SetGlobalFloat("_FurStep", i / (step - 1.0f));
